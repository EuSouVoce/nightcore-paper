...
public class ConfigValue<T> {
    ...
    public ConfigValue(@NotNull final String path, @NotNull final Reader<T> reader, @NotNull final Writer<T> writer, @NotNull final T defaultValue,
    ...
    @NotNull
    public static <T> ConfigValue<T> create(@NotNull final String path, @NotNull final Reader<T> reader, @NotNull final Supplier<T> defaultValue,
            @Nullable final String... description) {
        return ConfigValue.create(path, reader, FileConfig::set, defaultValue, description);
    }

    @NotNull
    public static ConfigValue<Boolean> create(@NotNull final String path, final boolean defaultValue, @Nullable final String... description) {
    ...
    @NotNull
    public static ConfigValue<String> create(@NotNull final String path, @NotNull final String defaultValue, @Nullable final String... description) {
    ...
    @NotNull
    public static ConfigValue<ItemStack> create(@NotNull final String path, @NotNull final ItemStack defaultValue, @Nullable final String... description) {
        return ConfigValue.create(path, FileConfig::getItem, FileConfig::setItem, defaultValue, description);
    }

    @NotNull
    public static ConfigValue<UniSound> create(@NotNull final String path, @NotNull final UniSound defaultValue, @Nullable final String... description) {
    ...
    @NotNull
    public static <E extends Enum<E>> ConfigValue<E> create(@NotNull final String path, @NotNull final Class<E> clazz, @NotNull final E defaultValue,
            @Nullable final String... description) {
    ...
    @NotNull
    public static <V> ConfigValue<Set<V>> forSet(@NotNull final String path, @NotNull final Function<String, V> reader, @NotNull final Writer<Set<V>> writer,
            @NotNull final Supplier<Set<V>> defaultValue, @Nullable final String... description) {
        return ConfigValue.forSet(path, reader, writer, defaultValue.get(), description);
    }

    @NotNull
    public static <V> ConfigValue<Set<V>> forSet(@NotNull final String path, @NotNull final Function<String, V> valFun, @NotNull final Writer<Set<V>> writer,
            @NotNull final Set<V> defaultValue, @Nullable final String... description) {
    ...
    @NotNull
    public static <K, V> ConfigValue<Map<K, V>> forMap(@NotNull final String path, @NotNull final Function<String, K> keyFun,
            @NotNull final TriFunction<FileConfig, String, String, V> valFun, @NotNull final Writer<Map<K, V>> writer, @NotNull final Map<K, V> defaultValue,
            @Nullable final String... description) {
    ...
    public static <K, V, M extends Map<K, V>> ConfigValue<M> forMap(@NotNull final String path, @NotNull final Function<String, K> keyFun,
            @NotNull final TriFunction<FileConfig, String, String, V> valFun, @NotNull final Supplier<M> mapSupplier, @NotNull final Writer<M> writer,
            @NotNull final M defaultValue, @Nullable final String... description) {
    ...
    @NotNull
    public static <V> ConfigValue<Map<String, V>> forMap(@NotNull final String path, @NotNull final TriFunction<FileConfig, String, String, V> function,
            @NotNull final Writer<Map<String, V>> writer, @NotNull final Supplier<Map<String, V>> defaultValue, @Nullable final String... description) {
        return ConfigValue.forMap(path, String::toLowerCase, function, writer, defaultValue.get(), description);
    }

    @NotNull
    public static <V> ConfigValue<Map<String, V>> forMap(@NotNull final String path, @NotNull final TriFunction<FileConfig, String, String, V> function,
            @NotNull final Writer<Map<String, V>> writer, @NotNull final Map<String, V> defaultValue, @Nullable final String... description) {
