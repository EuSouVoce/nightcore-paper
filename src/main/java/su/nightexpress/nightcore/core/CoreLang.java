...
public class CoreLang {
    // @formatter:off
    public static final LangString COMMAND_ARGUMENT_FORMAT_REQUIRED = LangString.of("Command.Argument.Type.Required", Tags.LIGHT_RED.enclose("<" + Placeholders.GENERIC_NAME + ">"));

    public static final LangString COMMAND_ARGUMENT_FORMAT_OPTIONAL = LangString.of("Command.Argument.Type.Optional", Tags.LIGHT_YELLOW.enclose("[" + Placeholders.GENERIC_NAME + "]"));

    public static final LangString COMMAND_FLAG_FORMAT = LangString.of("Command.Flag.Format", Tags.LIGHT_GRAY.enclose("[" + Placeholders.GENERIC_NAME + "]"));
    ...
    public static final LangText COMMAND_HELP_LIST = LangText.of("Command.Help.List",
        Placeholders.TAG_NO_PREFIX,
        " ",
        "  " + Tags.YELLOW.enclose(Tags.BOLD.enclose(Placeholders.GENERIC_NAME)) + Tags.GRAY.enclose(" - ") + Tags.YELLOW.enclose(Tags.BOLD.enclose("Commands:")),
        " ",
        Tags.GRAY.enclose("  " + Tags.RED.enclose(Tags.BOLD.enclose("<>")) + " - Required, " + Tags.GREEN.enclose(Tags.BOLD.enclose("[]")) + " - Optional."),
        " ",
    ...
    public static final LangString COMMAND_HELP_ENTRY = LangString.of("Command.Help.Entry",
        "  " + Tags.YELLOW.enclose("/" + Placeholders.COMMAND_LABEL) + " " + Tags.ORANGE.enclose(Placeholders.COMMAND_USAGE) + Tags.GRAY.enclose(" - " + Placeholders.COMMAND_DESCRIPTION)
    );
    ...
    public static final LangText ERROR_COMMAND_PARSE_FLAG = LangText.of("Error.Command.ParseFlag",
        Tags.LIGHT_GRAY.enclose("Invalid value " + Tags.LIGHT_RED.enclose(Placeholders.GENERIC_VALUE) + " for " + Tags.LIGHT_RED.enclose(Placeholders.GENERIC_NAME) + " flag."));

    public static final LangText ERROR_COMMAND_PARSE_ARGUMENT = LangText.of("Error.Command.ParseArgument",
        Tags.LIGHT_GRAY.enclose("Invalid value " + Tags.LIGHT_RED.enclose(Placeholders.GENERIC_VALUE) + " for " + Tags.LIGHT_RED.enclose(Placeholders.GENERIC_NAME) + " argument."));
    ...
    public static final LangText ERROR_COMMAND_USAGE = LangText.of("Error.Command.Usage",
        Placeholders.TAG_NO_PREFIX,
        " ",
        Tags.RED.enclose("Error: ") + Tags.GRAY.enclose("Wrong arguments!"),
        Tags.RED.enclose("Usage: ") + Tags.YELLOW.enclose("/" + Placeholders.COMMAND_LABEL) + " " + Tags.ORANGE.enclose(Placeholders.COMMAND_USAGE),
        " "
    );
    ...
    public static final LangText EDITOR_ACTION_EXIT = LangText.of("Editor.Action.Exit",
        ...
        Tags.GRAY.enclose("Click " +
            Tags.CLICK.enclose(
                ...
                Tags.HOVER.enclose(Tags.GREEN.enclose("[Here]"), Tags.GRAY.enclose("Click to cancel")),
                "/" + Dialog.EXIT
            )
            + " to leave input mode."),
        "");
    ...
    public static final LangItem EDITOR_ITEM_RETURN        = LangItem.of("Editor.Generic.Return", Tags.LIGHT_GRAY.enclose(Tags.BOLD.enclose("Return")));
    public static final LangItem EDITOR_ITEM_NEXT_PAGE     = LangItem.of("Editor.Generic.NextPage", Tags.LIGHT_GRAY.enclose("Next Page →"));
    public static final LangItem EDITOR_ITEM_PREVIOUS_PAGE = LangItem.of("Editor.Generic.PreviousPage", Tags.LIGHT_GRAY.enclose("← Previous Page"));
