...
public class ReloadCommand {
    ...
    public static void inject(@NotNull final NightCorePlugin plugin, @NotNull final ChainedNode node,
            @NotNull final UniPermission permission) {
    ...
    public static boolean execute(@NotNull final NightCorePlugin plugin, @NotNull final CommandContext context,
